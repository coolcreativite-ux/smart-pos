      ...
      <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col items-center justify-center border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-xl p-6 bg-slate-50/50 dark:bg-slate-900/20">
            <p className="text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Logo de l'entreprise</p>
            <p className="text-xs text-slate-500 dark:text-slate-400 mb-4 text-center">Apparaît sur tous les documents : tickets, factures, reçus</p>
            <div className="w-32 h-32 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden bg-white flex items-center justify-center mb-4 shadow-inner relative group">
                {localSettings.storeLogoUrl ? (
                    <img src={localSettings.storeLogoUrl} alt="Logo de l'entreprise" className="w-full h-full object-contain" />
                ) : (
        ...
        <div className="mt-8 pt-6 border-t border-slate-100 dark:border-slate-700 flex items-center gap-4">
            ...
            <button 
                ...
                className="px-6 py-3 bg-green-600 text-white font-bold rounded-xl hover:bg-green-700 transition-all active:scale-95 flex items-center gap-2 shadow-lg shadow-green-500/20"
            >
